...
namespace Com.Google.Zxing.Maxicode {
	...
	public sealed partial class MaxiCodeReader : global::Java.Lang.Object, global::Com.Google.Zxing.IReader {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/zxing/maxicode/MaxiCodeReader", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MaxiCodeReader); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (MaxiCodeReader)) {
					SetHandle (
