...
namespace Com.Google.Zxing.Qrcode.Decoder {
	...
	public sealed partial class Decoder : global::Java.Lang.Object {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/zxing/qrcode/decoder/Decoder", ref java_class_handle);
			}
		}
		...
		static IntPtr id_decode_arrayarrayZLjava_util_Map_;
		...
		public unsafe global::Com.Google.Zxing.Common.DecoderResult Decode (bool[][] p0, global::System.Collections.Generic.IDictionary<global::Com.Google.Zxing.DecodeHintType, object> p1)
		{
			if (id_decode_arrayarrayZLjava_util_Map_ == IntPtr.Zero)
				id_decode_arrayarrayZLjava_util_Map_ = JNIEnv.GetMethodID (class_ref, "decode", "([[ZLjava/util/Map;)Lcom/google/zxing/common/DecoderResult;");
			IntPtr native_p0 = JNIEnv.NewArray (p0);
			...
			try {
				...
				global::Com.Google.Zxing.Common.DecoderResult __ret = global::Java.Lang.Object.GetObject<global::Com.Google.Zxing.Common.DecoderResult> (JNIEnv.CallObjectMethod  (Handle, id_decode_arrayarrayZLjava_util_Map_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				if (p0 != null) {
					JNIEnv.CopyArray (native_p0, p0);
