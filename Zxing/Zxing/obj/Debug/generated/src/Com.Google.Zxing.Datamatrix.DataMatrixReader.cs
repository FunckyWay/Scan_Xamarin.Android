...
namespace Com.Google.Zxing.Datamatrix {
	...
	public sealed partial class DataMatrixReader : global::Java.Lang.Object, global::Com.Google.Zxing.IReader {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/zxing/datamatrix/DataMatrixReader", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (DataMatrixReader); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (DataMatrixReader)) {
					SetHandle (
