...
namespace Com.Google.Zxing.Oned.Rss.Expanded {
	...
	public sealed partial class RSSExpandedReader : global::Com.Google.Zxing.Oned.Rss.AbstractRSSReader {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/zxing/oned/rss/expanded/RSSExpandedReader", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (RSSExpandedReader); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (RSSExpandedReader)) {
					SetHandle (
