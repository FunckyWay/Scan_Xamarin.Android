...
namespace Com.Google.Zxing {
	...
	public sealed partial class MultiFormatWriter : global::Java.Lang.Object, global::Com.Google.Zxing.IWriter {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/zxing/MultiFormatWriter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MultiFormatWriter); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (MultiFormatWriter)) {
					SetHandle (
