...
namespace Com.Google.Zxing.Oned {
	...
	public sealed partial class MultiFormatOneDReader : global::Com.Google.Zxing.Oned.OneDReader {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/zxing/oned/MultiFormatOneDReader", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MultiFormatOneDReader); }
		}
		...
		public unsafe MultiFormatOneDReader (global::System.Collections.Generic.IDictionary<global::Com.Google.Zxing.DecodeHintType, object> p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (MultiFormatOneDReader)) {
					SetHandle (
