...
namespace Com.Google.Zxing {
	...
	public partial interface IWriter : IJavaObject {
		...
		[Register ("encode", "(Ljava/lang/String;Lcom/google/zxing/BarcodeFormat;II)Lcom/google/zxing/common/BitMatrix;", "GetEncode_Ljava_lang_String_Lcom_google_zxing_BarcodeFormat_IIHandler:Com.Google.Zxing.IWriterInvoker, Zxing")]
		...
		[Register ("encode", "(Ljava/lang/String;Lcom/google/zxing/BarcodeFormat;IILjava/util/Map;)Lcom/google/zxing/common/BitMatrix;", "GetEncode_Ljava_lang_String_Lcom_google_zxing_BarcodeFormat_IILjava_util_Map_Handler:Com.Google.Zxing.IWriterInvoker, Zxing")]
	...
	internal class IWriterInvoker : global::Java.Lang.Object, IWriter {

		static IntPtr java_class_ref = JNIEnv.FindClass ("com/google/zxing/Writer");
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (IWriterInvoker); }
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.google.zxing.Writer"));
			return handle;
		}
...
#pragma warning disable 0169
		static Delegate GetEncode_Ljava_lang_String_Lcom_google_zxing_BarcodeFormat_IIHandler ()
		{
			if (cb_encode_Ljava_lang_String_Lcom_google_zxing_BarcodeFormat_II == null)
				cb_encode_Ljava_lang_String_Lcom_google_zxing_BarcodeFormat_II = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr, int, int, IntPtr>) n_Encode_Ljava_lang_String_Lcom_google_zxing_BarcodeFormat_II);
		...
		{
			global::Com.Google.Zxing.IWriter __this = global::Java.Lang.Object.GetObject<global::Com.Google.Zxing.IWriter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
